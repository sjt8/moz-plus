...
from . import views
from .views import add_season,add_episode,edit_season,delete_Season,delete_episode,add_series,edit_episode,add_movies,edit_moviepart,add_moviespart
...
urlpatterns = [
    ...
    path('content-creator/movies/<int:movie_id>/', views.movie_details, name='movies_details'),
    path('add-movies/', add_movies, name='add_movies'),
    path('add-moviepart/', add_moviespart, name='add_moviepart'),
    path("edit-moviepart/<int:passed_id>/",edit_moviepart, name='edit_moviepart'),
]
